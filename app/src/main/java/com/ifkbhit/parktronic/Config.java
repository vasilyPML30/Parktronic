...
public class Config {
    ...
    public static final Point[][] UPPER_POINTS = {{new Point(35, 102), new Point(159, 28), new Point(299, 6), new Point(438, 27), new Point(563, 102)},
    ...
    public static final Point[][] LOWER_POINTS = {{new Point(6, 1157), new Point(141, 1261), new Point(305, 1286), new Point(469, 1261), new Point(603, 1157)},
